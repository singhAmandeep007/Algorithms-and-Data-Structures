...
// 1st solution
function chunk1(array: Array<number>, size: number) {
...
// 2nd solution
function chunk2(array: Array<number>, size: number) {
  if (!size || array.length < 2) {
    return array;
  }
  let chunkedArray = [];
...
//3rd solution
function chunk3(array: Array<number>, size: number) {
  if (!size || array.length < 2) {
    return array;
  }
...
function chunk4(array: Array<number>, size: number, result: Array<number[]> = []) {
