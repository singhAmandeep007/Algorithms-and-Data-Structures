import { validMountainArray1, validMountainArray2 } from "./index";

describe.each([
  { name: "validMountainArray1", func: validMountainArray1 },
  { name: "validMountainArray2", func: validMountainArray2 },
])("$name", ({ func }) => {
  test.each([
