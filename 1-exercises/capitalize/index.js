...
/*
	This checks for the first character of the entire string ^[a-z] or a character following a space \s[a-z], and converts it to uppercase. 
*/

module.exports = [capitalize1, capitalize2, capitalize3];
